...
import { keyBy, groupBy } from 'lodash/collection'
import { concat } from 'lodash/array'
import { get, extend } from 'lodash/object'
import { map as fpMap, uniq as fpUniq, filter as fpFilter, sortBy as fpSortBy, flow } from 'lodash/fp'
...
const getComputedAssets = (hotelAssets, hotelVirtualAssets) => {
  return concat(hotelAssets || [], hotelVirtualAssets || [])
}
