...
var ACTION_HANDLERS = (_ACTION_HANDLERS = {}, _ACTION_HANDLERS[_updates2['default'].UPDATES_RESET] = function () {
...
}, _ACTION_HANDLERS[_updates2['default'].ROOM_CLEAN_PAUSE] = function (state, _ref4) {
...
}, _ACTION_HANDLERS[_updates2['default'].ROOM_CLEAN_UNPAUSE] = function (state, _ref5) {
...
}, _ACTION_HANDLERS[_updates2['default'].ROOM_CLEAN_FLUSH] = function (state, _ref6) {
  var roomId = _ref6.roomId;
  var rooms = state.rooms;

  return state.set('rooms', rooms.without(roomId));
}, _ACTION_HANDLERS[_updates2['default'].PHOTO_UPLOAD] = function (state, _ref7) {
  var path = _ref7.path;
  var id = _ref7.id;

  return state.setIn(['photos', id], (0, _seamlessImmutable2['default'])({ path: path }));
}, _ACTION_HANDLERS[_updates2['default'].PHOTO_STORE] = function (state, _ref8) {
  var id = _ref8.id;
  var url = _ref8.url;

  return state.setIn(['photos', id, 'url'], url);
}, _ACTION_HANDLERS[_updates2['default'].PHOTO_REMOVE] = function (state, _ref9) {
  var id = _ref9.id;
