    ...
    return (
      <View style={styles.container}>
        <KeyboardAvoidingView behavior="position">
          ...
          <View style={[padding.a10, jcc]}>
            <ListView
              horizontal={true}
              data={hotel.users}
              renderRow={(user) => <Field name="username" user={user} component={UserSelect} focusPassword={this.focusPassword} />}
            />
          </View>
        ...
        <View style={styles.btnContainer}>
          <TouchableOpacity style={styles.continueBtn} onPress={handleSubmit(submitUserLogin)}>
