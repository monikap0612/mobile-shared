...
const TEAM_MAP = {
  'housekeeping': { label: 'Housekeeping', userFlags: ['isAttendant', 'isInspector'] },
  'attendant': { label: 'Attendants', userFlags: ['isAttendant'] },
  'inspector': { label: 'Inspectors', userFlags: ['isInspector'] },
  'maintenance': { label: 'Maintenance', userFlags: ['isMaintenance'] },
  'runner': { label: 'Runners', userFlags: ['isRoomRunner'] },
  'concierge': { label: 'Concierge', userFlags: ['isReceptionist'] },
  'management': { label: 'Management', userFlags: ['isAdministrator'] },
};
...
class AssignmentSelect extends Component {
    ...
    return (
      <View>
        <View style={styles.headingContainer}>
          <Text style={styles.headingLabel}>{ teamInformation.label.toUpperCase() }</Text>
        </View>
  ...
  _renderGroups(groups) {
    ...
    return (
      <View>
        <View style={styles.headingContainer}>
          <Text style={styles.headingLabel}>{ 'Groups'.toUpperCase() }</Text>
        </View>
