...
const Opener = ({ assignments, toggle, onRemove }) => (
  ...
  >
    <SectionHeading style={{ paddingLeft: 15 }}>{ I18n.t('base.components.selectassignmentmodal.select-assignment') }</SectionHeading>
    {
...
class ModalAssignment extends Component {
  ...
  render() {
    const { assignmentOptions, selectedAssignments, updateAssignments, removeAssignment } = this.props
