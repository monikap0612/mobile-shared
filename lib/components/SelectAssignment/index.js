...
class ModalAssignment extends Component {
  ...
  render() {
    const { assignmentOptions, selectedAssignments, updateAssignments, removeAssignment, isShowHeader, isOptional } = this.props
    ...
    return (
      <View>
        { isShowHeader && (
          isOptional ?
            <SectionHeader value={`${I18n.t('base.ubiquitous.assignments')} (${I18n.t('base.ubiquitous.optional')})`} />
          :
            <SectionHeader value={I18n.t('base.ubiquitous.assignments')} />
        )}
        <Opener
