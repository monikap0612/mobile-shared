...
class TaskSettings extends Component {
  ...
  _renderPriority() {
    ...
    return (
      <View>
        <SectionHeading style={{paddingLeft: 15, marginTop: 15}}>Priority</SectionHeading>
  ...
  _renderMandatory() {
    ...
    return (
      <View>
        <SectionHeading style={{paddingLeft: 15, marginTop: 15}}>Mandatory</SectionHeading>
        <View style={styles.optionContainer}>
  ...
  _renderBlocking() {
    ...
    return (
      <View>
        <SectionHeading style={{paddingLeft: 15, marginTop: 15}}>Blocking</SectionHeading>
        <View style={styles.optionContainer}>
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Button style={{ height: 50, backgroundColor: '#3CC86B', borderRadius: 5, margin: 3 }} onPress={handleSubmit}>
          <Text style={styles.bigBtnText}>{ `Submit Task`.toUpperCase() }</Text>
        </Button>
      </View>
    )
  }
