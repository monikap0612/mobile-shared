  ...
  render() {
    ...
    return (
      <View>
        ...
        <Section title="SELECT GLITCH CATEGORY">
          <Field
            name="category"
        ...
        <Section title="GLITCH INFORMATION">
          <Text style={styles.inputHeader}>INCIDENT DESCRIPTION</Text>
        ...
        <View style={styles.submitButtonContainer}>
          <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
            <Text style={styles.submitButtonText}>SUBMIT NEW GLITCH</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
