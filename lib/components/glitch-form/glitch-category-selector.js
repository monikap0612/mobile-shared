...
import { Icon as ShoutIcon } from '@shoutem/ui';
    ...
    return (
      <View>
        <TouchableOpacity onPress={this._handleInputPress} style={styles.dropdownButton}>
          <Text style={styles.dropdownButtonText}>{ value ? value : 'Select Category' }</Text>
          <ShoutIcon name="down-arrow" />
        </TouchableOpacity>
        <Modal
      ...
      <View style={styles.modalContentContainer}>
        <View style={styles.titleBar}>
          <View style={styles.titleBarTitleContainer}>
            <Text style={styles.titleBarTitle}>SELECT GLITCH CATEGORY</Text>
          </View>
    ...
    return (
      <View style={styles.modalContentContainer}>
        <View style={styles.titleBar}>
          ...
          <View style={styles.titleBarTitleContainer}>
            <Text style={styles.titleBarTitle}>SELECT GLITCH</Text>
          </View>

        </View>
        <View style={styles.categoryHeader}>
          <FaIcon name={iconName} size={40} style={styles.categoryHeaderIcon}/>
          <Text style={styles.categoryHeaderText}>{ selectedCategory.toUpperCase() }</Text>
        </View>
        <ScrollView>
        {
