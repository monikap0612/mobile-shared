...
exports['default'] = function (_ref) {
  ...
  function* fetchRoomStatuses() {
    var _ref4 = yield (0, _effects.select)(),
        ...
        hotelId = _ref4$auth.hotelId,
        token = _ref4$auth.token;
  ...
  function* fetchPlannings() {
    var _ref6 = yield (0, _effects.select)(),
        ...
        hotelId = _ref6$auth.hotelId,
        token = _ref6$auth.token;
  ...
  function* fetchPlanningsRunner() {
    var _ref8 = yield (0, _effects.select)(),
        _ref8$auth = _ref8.auth,
        hotelId = _ref8$auth.hotelId,
        token = _ref8$auth.token;
  ...
  function* fetchTasks() {
    var _ref12 = yield (0, _effects.select)(),
        ...
        hotelId = _ref12$auth.hotelId,
        token = _ref12$auth.token;
