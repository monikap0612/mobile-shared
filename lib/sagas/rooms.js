...
exports.fetchRoomsFlow = fetchRoomsFlow;
exports.watchRoomsFlow = watchRoomsFlow;
exports.fetchFloors = fetchFloors;
exports.fetchFloorsFlow = fetchFloorsFlow;
exports.watchFloorsFlow = watchFloorsFlow;
exports.fetchRoomStatuses = fetchRoomStatuses;
exports.fetchRoomStatusesFlow = fetchRoomStatusesFlow;
exports.watchRoomStatusesFlow = watchRoomStatusesFlow;
exports.fetchRoomHousekeepings = fetchRoomHousekeepings;
exports.fetchRoomHousekeepingsFlow = fetchRoomHousekeepingsFlow;
exports.watchRoomHousekeepingsFlow = watchRoomHousekeepingsFlow;
exports.fetchPlannings = fetchPlannings;
exports.fetchPlanningsFlow = fetchPlanningsFlow;
exports.watchPlanningsFlow = watchPlanningsFlow;
exports.fetchPlanningsNight = fetchPlanningsNight;
exports.fetchPlanningsNightFlow = fetchPlanningsNightFlow;
exports.watchPlanningsNightFlow = watchPlanningsNightFlow;
exports.fetchPlanningsRunner = fetchPlanningsRunner;
exports.fetchPlanningsRunnerFlow = fetchPlanningsRunnerFlow;
exports.watchPlanningsRunnerFlow = watchPlanningsRunnerFlow;
exports.fetchCalendar = fetchCalendar;
exports.fetchCalendarFlow = fetchCalendarFlow;
exports.watchCalendarFlow = watchCalendarFlow;
exports.fetchRoomNotes = fetchRoomNotes;
exports.fetchRoomNotesFlow = fetchRoomNotesFlow;
exports.watchRoomNotesFlow = watchRoomNotesFlow;
exports.fetchCatalogs = fetchCatalogs;
exports.fetchCatalogsFlow = fetchCatalogsFlow;
exports.watchCatalogsFlow = watchCatalogsFlow;
exports.fetchTasks = fetchTasks;
exports.fetchTasksFlow = fetchTasksFlow;
exports.watchTasksFlow = watchTasksFlow;
...
var ROOMS_API = _api2['default'] + '/rooms';
var FLOORS_API = _api2['default'] + '/floors';
var ROOM_STATUSES_API = _api2['default'] + '/room_statuses';
var ROOM_HOUSEKEEPINGS_API = _api2['default'] + '/room_housekeepings';
var PLANNINGS_API = _api2['default'] + '/attendant_plannings';
var PLANNINGS_NIGHT_API = _api2['default'] + '/attendant_planning_nights';
var PLANNINGS_RUNNER_API = _api2['default'] + '/runner_plannings';
var CALENDAR_API = _api2['default'] + '/calendar';
var ROOM_NOTES_API = _api2['default'] + '/room_notes';
var CATALOGS_API = _api2['default'] + '/catalog_by_hotel';
var TASKS_API = _api2['default'] + '/tasks';
