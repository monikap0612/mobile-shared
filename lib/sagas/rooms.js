...
exports['default'] = function (_ref) {
  ...
  var ROOMS_API = API_URL + '/rooms';
  var FLOORS_API = API_URL + '/floors';
  var ROOM_STATUSES_API = API_URL + '/room_statuses';
  var ROOM_HOUSEKEEPINGS_API = API_URL + '/room_housekeepings';
  var PLANNINGS_API = API_URL + '/attendant_plannings';
  var PLANNINGS_NIGHT_API = API_URL + '/attendant_planning_nights';
  var PLANNINGS_RUNNER_API = API_URL + '/runner_plannings';
  var CALENDAR_API = API_URL + '/calendar';
  var ROOM_NOTES_API = API_URL + '/room_notes';
  var CATALOGS_API = API_URL + '/catalog_by_hotel';
  var TASKS_API = API_URL + '/tasks';
