...
exports['default'] = function (_ref) {
  ...
  function* submitNewGlitch(data) {
    ...
    var room_id = data.glitchRoomId,
        room_name = data.glitchRoomName,
        name = data.glitchGuestName,
        email = data.glitchGuestEmail,
        category = data.glitchCategory,
        description = data.glitchDescription,
        action = data.glitchAction,
        followup = data.glitchFollowup,
        cost = data.glitchCost;
