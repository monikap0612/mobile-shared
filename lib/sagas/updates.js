...
exports['default'] = function (_ref) {
  ...
  function* logClean(_ref4) {
    ...
    var _ref5 = yield (0, _effects.select)(),
        ...
        roomUpdates = _ref5.updates.rooms,
        hotelRooms = _ref5.rooms.hotelRooms;
  ...
  function* logOther(_ref6) {
    ...
    var _ref7 = yield (0, _effects.select)(),
        ...
        roomUpdates = _ref7.updates.rooms,
        hotelRooms = _ref7.rooms.hotelRooms;
  ...
  function* createRoomNote(_ref9) {
    ...
    var _ref10 = yield (0, _effects.select)(),
        ...
        hotelId = _ref10$auth.hotelId,
        token = _ref10$auth.token,
        user = _ref10$auth.user,
        userId = _ref10$auth.userId;
  ...
  function* submitLostItem(_ref17) {
    var desc = _ref17.desc,
        roomId = _ref17.roomId,
        photoId = _ref17.photoId;

    var _ref18 = yield (0, _effects.select)(),
        _ref18$auth = _ref18.auth,
        hotelId = _ref18$auth.hotelId,
        token = _ref18$auth.token,
        user = _ref18$auth.user,
        userId = _ref18$auth.userId,
        photos = _ref18.updates.photos;
  ...
  function* addLostItemFlow(_ref19) {
    var desc = _ref19.desc,
        roomId = _ref19.roomId,
        photoId = _ref19.photoId;
  ...
  function* submitInventoryWithdrawl(_ref20) {
    var asset = _ref20.asset,
        change = _ref20.change,
        roomId = _ref20.roomId;

    var _ref21 = yield (0, _effects.select)(),
        _ref21$auth = _ref21.auth,
        hotelId = _ref21$auth.hotelId,
        token = _ref21$auth.token,
        user = _ref21$auth.user,
        userId = _ref21$auth.userId;
  ...
  function* submitInventoryWithdrawlFlow(_ref22) {
    ...
    var _ref23 = yield (0, _effects.select)(),
        inventory = _ref23.updates.inventory,
        hotelAssetRooms = _ref23.assets.hotelAssetRooms;
  ...
  function* submitInventoryRestock(_ref24) {
    ...
    var _ref25 = yield (0, _effects.select)(),
        _ref25$auth = _ref25.auth,
        hotelId = _ref25$auth.hotelId,
        token = _ref25$auth.token,
        user = _ref25$auth.user,
        userId = _ref25$auth.userId;
  ...
  function* createTask(task) {
    var _ref27 = yield (0, _effects.select)(),
        _ref27$auth = _ref27.auth,
        hotelId = _ref27$auth.hotelId,
        token = _ref27$auth.token,
        userId = _ref27$auth.userId;
  ...
  function* createVirtualAsset(_ref28) {
    ...
    var _ref29 = yield (0, _effects.select)(),
        _ref29$auth = _ref29.auth,
        hotelId = _ref29$auth.hotelId,
        token = _ref29$auth.token,
        userId = _ref29$auth.userId;
  ...
  function* createTaskFlow(_ref30) {
    ...
    var _ref31 = yield (0, _effects.select)(),
        _ref31$auth = _ref31.auth,
        hotelId = _ref31$auth.hotelId,
        token = _ref31$auth.token,
        userId = _ref31$auth.userId,
        hotel = _ref31$auth.hotel,
        photos = _ref31.updates.photos,
        _ref31$users = _ref31.users,
        users = _ref31$users.users,
        hotelGroups = _ref31$users.hotelGroups;
    ...
    try {
      ...
      if (data.activeGlitch && response.task.uuid) {
        ...
        yield (0, _effects.put)(_glitches2['default'].glitchTask(response.task.uuid));
      }
  ...
  function* updateTask(_ref32) {
    ...
    var _ref33 = yield (0, _effects.select)(),
        _ref33$auth = _ref33.auth,
        hotelId = _ref33$auth.hotelId,
        token = _ref33$auth.token,
        userId = _ref33$auth.userId;
