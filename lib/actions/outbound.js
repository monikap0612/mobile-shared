  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_ROOM_CLEAN_FAILURE, meta: { roomId, status, tapTs } }
      },
      auth: {
        enable: true,
        useUserSession: true
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        commit: { type: OutboundTypes.OUTBOUND_ROOM_UPDATE_SUCCESS },
        rollback: { type: OutboundTypes.OUTBOUND_ROOM_RESET_FAILURE, meta: { roomId, tapTs }  }
      },
      auth: {
        enable: true,
        useUserSession: true
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_LOG_FAILURE, meta: { data } }
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        commit: { type: OutboundTypes.OUTBOUND_ROOM_UPDATE_SUCCESS },
        rollback: { type: OutboundTypes.OUTBOUND_ROOM_UPDATE_FAILURE, meta: { roomId, field, value, tapTs } }
      },
      auth: {
        enable: true,
        useUserSession: true
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        commit: { type: OutboundTypes.OUTBOUND_ROOM_UPDATE_SUCCESS },
        rollback: { type: OutboundTypes.OUTBOUND_ROOM_UPDATE_FAILURE, meta: { roomId, field: 'roomHousekeeping', value: roomHousekeeping, tapTs } }
      },
      auth: {
        enable: true,
        useUserSession: true
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_CREATE_FAILURE, meta: { task, tapTs } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_UPDATE_FAILURE, meta: { uuid, data, tapTs } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_UPDATE_BATCH_FAILURE, meta: { userId, tasks, tapTs } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_REASSIGN_FAILURE, meta: { uuid, data, tapTs } }
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_CONVERT_FAILURE, meta: { uuid, data, tapTs } }
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_NOTIFICATION_CREATE_FAILURE, meta: { task, tapTs } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_GLITCH_UPDATE_FAILURE, meta: { glitchId, task_id, user_id } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_PHOTO_FAILURE, meta: { path, task } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_NOTIFICATION_PHOTO_FAILURE, meta: { path, task } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OUTBOUND.OUTBOUND_LF_PHOTO_FAILURE, meta: { path, photoId, desc, roomId } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: UpdatesTypes.OUTBOUND_LF_SUBMIT_FAILURE, meta: { roomId, nameOrDescription, image } },
      },
      auth: {
        enable: true,
        useUserId: true
