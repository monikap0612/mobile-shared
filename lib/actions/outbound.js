  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: UpdatesTypes.TASK_CREATE_FAILURE, meta: { task } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_CONVERT_FAILURE }
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_NOTIFICATION_CREATE_FAILURE },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: UpdatesTypes.NOTIFICATION_CREATE_FAILURE, meta: { task } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: UpdatesTypes.LOST_ITEM_ADD_FAILURE, meta: { photoId, desc, roomId } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: UpdatesTypes.LOST_ITEM_ADD_FAILURE },
      },
      auth: {
        enable: true,
        useUserId: true
