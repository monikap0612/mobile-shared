  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OUTBOUND.OUTBOUND_LF_PHOTO_FAILURE, meta: { path, photoId, desc, roomId, outboundLabel } },
      },
      auth: {
        enable: true
      }
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: UpdatesTypes.OUTBOUND_LF_SUBMIT_FAILURE, meta: { roomId, nameOrDescription, image, outboundLabel } },
      },
      auth: {
        enable: true,
        useUserId: true
