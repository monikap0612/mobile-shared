...
import { get, extend, pick, pull, includes, find } from 'lodash';
...
import { locationsSelector, assignmentSelector, enableRecentTasksSelector } from './selectors';
...
class CreateTaskLayout extends Component {
  ...
  _handleSubmit = () => {
    ...
    if (this.props.isEnableRecent && layout !== "maintenance") {
      this.props.addRecent(pick(this.state, [
        'selectedAsset',
        'selectedAction',
        'selectedModel',
        'selectedAssignments',
