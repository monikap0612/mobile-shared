        ...
        <View style={[flx1]}>
          ...
          <View style={[flx1]}>
            ...
            <FlatList
              ...
              ListFooterComponent={() => isExisting ? null : !!searchQuery && searchQuery.length ? <AssetSelectRow isCreate={true} searchQuery={searchQuery} onPress={handleSelectAsset} index={0} /> : null}
              />
          </View>
