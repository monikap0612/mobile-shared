...
class NotesLayout extends Component {
  ...
  render() {
    ...
    const noteRows = roomNotes.map(note => <RoomNoteRow key={note.id} note={note} user={get(indexedUsers, note.user_id, {})} removeNote={this._handleRemoveNote.bind(this)} />);
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Button style={{ backgroundColor: '#44A454', height: 44, borderRadius: 4, marginBottom: 3, marginTop: 5 }} onPress={this._handleAddNote.bind(this)}>
