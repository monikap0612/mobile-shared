          ...
          <View style={[flx1]}>
            ...
            <View style={[flx1]}>
              <ListView
                ...
                renderRow={(rowData, secId, index) => <InventoryUpdateRow data={rowData} index={index} adjustInventory={this._adjustInventory} rejectInventory={this._rejectInventory} resetInventory={this._resetInventory} onScroll={this._handleScroll} />}
                />
            </View>
