...
const Tab = ({ onPress, text, value, active }) => (
  <TouchableOpacity
    style={[flx1, padding.y10, padding.x5, jcc, aic, active ? blue300.bg : white.bg, {height: 50}]}
...
export const TabsContent = ({ onPress, activeTab, isSendDisabled }) => (
  <View style={[flx1, flxRow, white.bg, grey400.bc, border.a0, border.l1, { height: 50 }]}>
    <Tab
      value={0}
