...
const durableAssetsSelector = state => state.assets.hotelDurableAssets;
...
const getComputedAssets = (hotelAssets, hotelVirtualAssets, hotelDurableAssets, hotelCustomActions) => {
  const sortedAssets = sortBy(concat(hotelAssets || [], hotelVirtualAssets || [], hotelDurableAssets || []), 'name');
