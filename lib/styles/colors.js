...
export const taskStarted = buildColor("#B5ECB5");
export const taskAccepted = buildColor("#8FC456");
export const taskWaiting = buildColor("#4BB8E3");
export const taskPending = buildColor("#F0C800");
export const taskCancelled = buildColor("#A1A1A1");
export const taskUnclaimed = buildColor("#FF7E14");
export const taskPaused = buildColor("#F0C800");
