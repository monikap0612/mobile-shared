...
import ReduxFormater from './formaters/redux';
...
class Logger {
  ...
  static defaultManager = new FileManager()
  static defaultFormater = new ReduxFormater()
  static defaultAdapter = ReduxAdapter
